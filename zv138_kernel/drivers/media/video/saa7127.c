...
static int saa7127_set_vps(struct v4l2_subdev *sd, const struct v4l2_sliced_vbi_data *data)
{
	...
	printk(KERN_WARNING"saa7127_set_vps!!!!!!!!!!!\n");
...
static int saa7127_set_cc(struct v4l2_subdev *sd, const struct v4l2_sliced_vbi_data *data)
{
	...
	int enable = (data->line != 0);
	printk(KERN_WARNING"saa7127_set_cc!!!!!!!!!!!\n");
...
static int saa7127_set_xds(struct v4l2_subdev *sd, const struct v4l2_sliced_vbi_data *data)
{
	...
	int enable = (data->line != 0);
	printk(KERN_WARNING"saa7127_set_xds!!!!!!!!!!!\n");
...
static int saa7127_set_wss(struct v4l2_subdev *sd, const struct v4l2_sliced_vbi_data *data)
{
	struct saa7127_state *state = to_state(sd);
	int enable = (data->line != 0);
	printk(KERN_WARNING"saa7127_set_wss!!!!!!!!!!!\n");
...
{
	struct saa7127_state *state = to_state(sd);
	printk(KERN_WARNING"saa7127_set_video_enable!!!!!!!!!!!\n");
...
static int saa7127_set_std(struct v4l2_subdev *sd, v4l2_std_id std)
{
	...
	printk(KERN_WARNING"saa7127_set_std!!!!!!!!!!!\n");

	if (std & V4L2_STD_525_60) {
		v4l2_info( sd, "Selecting 60 Hz video Standard\n");
		inittab = saa7127_init_config_60hz;
		state->reg_61 = SAA7127_60HZ_DAC_CONTROL;
	} else {
		v4l2_info( sd, "Selecting 50 Hz video Standard\n");
...
{
	struct saa7127_state *state = to_state(sd);
	printk(KERN_WARNING"saa7127_set_output_type!!!!!!!!!!!\n");
...
{
	struct saa7127_state *state = to_state(sd);
	printk(KERN_WARNING"saa7127_set_input_type!!!!!!!!!!!\n");
...
{
	struct saa7127_state *state = to_state(sd);
	printk(KERN_WARNING"saa7127_s_std_output!!!!!!!!!!!\n");
			     ...
			     u32 input, u32 output, u32 config)
{
	...
	printk(KERN_WARNING"saa7127_s_routing!!!!!!!!!!!\n");
...
static int saa7127_s_stream(struct v4l2_subdev *sd, int enable)
{
	...
	printk(KERN_WARNING"saa7127_s_stream!!!!!!!!!!!\n");
...
{
	struct saa7127_state *state = to_state(sd);
	printk(KERN_WARNING"saa7127_g_fmt!!!!!!!!!!!\n");
...
{
	printk(KERN_WARNING"saa7127_s_vbi_data!!!!!!!!!!!\n");
	switch (data->id) {
...
static int saa7127_g_register(struct v4l2_subdev *sd, struct v4l2_dbg_register *reg)
{
	...
	printk(KERN_WARNING"saa7127_g_register!!!!!!!!!!!\n");
...
static int saa7127_s_register(struct v4l2_subdev *sd, struct v4l2_dbg_register *reg)
{
	...
	printk(KERN_WARNING"saa7127_s_register!!!!!!!!!!!\n");
	if (!v4l2_chip_match_i2c_client(client, &reg->match))
		return -EINVAL;
	if (!capable(CAP_SYS_ADMIN))
		return -EPERM;
...
static int saa7127_g_chip_ident(struct v4l2_subdev *sd, struct v4l2_dbg_chip_ident *chip)
{
	struct saa7127_state *state = to_state(sd);
	struct i2c_client *client = v4l2_get_subdevdata(sd);
	printk(KERN_WARNING"saa7127_g_chip_ident!!!!!!!!!!!\n");
...
/*	if ((saa7127_read(sd, 0) & 0xe4) != 0 ||
		...
		v4l2_info( sd, "saa7127 not found\n");
		kfree(state);
		return -ENODEV;
	}
*/
