...
static const u8 aic3x_reg[AIC3X_CACHEREGNUM] = {
	...
	0x00, 0x00, 0x00, 0x60,	/* 12 */
	0x60, 0xff, 0xff, 0x00,	/* 16 */
	0x78, 0x78, 0x00, 0x78,	/* 20 */
	0x78, 0x00, 0x00, 0xfe,	/* 24 */
	0x00, 0x00, 0xfe, 0x00,	/* 28 */
	0x18, 0x18, 0x00, 0x00,	/* 32 */
	0x00, 0xc0, 0xc0, 0x00,	/* 36 */
	0xc0, 0x00, 0x00, 0x55,	/* 40 */
	0x55, 0x00, 0x00, 0x00,	/* 44 */
	0x00, 0x00, 0x00, 0x09,	/* 48 */
	0x81, 0x00, 0x81, 0x00,	/* 52 */
	0x00, 0x00, 0x09, 0x00,	/* 56 */
	0x00, 0x00, 0x00, 0x00,	/* 60 */
	0x81, 0x09, 0x00, 0x00,	/* 64 */
	0x00, 0x00, 0x00, 0x81,	/* 68 */
	0x09, 0x00, 0x00, 0x00,	/* 72 */
	0x00, 0x00, 0x00, 0x00,	/* 76 */
	0x00, 0x00, 0x81, 0x00,	/* 80 */
	0x00, 0x00, 0x09, 0x00,	/* 84 */
	0x00, 0x00, 0x00, 0x00,	/* 88 */
	0x81, 0x09, 0x00, 0x00,	/* 92 */
		       ...
		       unsigned int value)
{
	...
	{
		//printk(KERN_WARNING"writing 0x%x R%d ",value,reg);
		return 0;
	}
	else
	{
		//printk("aic write error\n");
		return -EIO;
	}
}
 ...
 */
static DECLARE_TLV_DB_SCALE(output_stage_tlv, -5900, 50, 0);
...
static int aic3x_mute(struct snd_soc_dai *dai, int mute)
{
	...
	if (mute) {
		...
		aic3x_write(codec, LDAC_VOL, 0x00);
		aic3x_write(codec, RDAC_VOL, 0x00);
		aic3x_write(codec,37,0xc0);
		aic3x_write(codec,38,0x04);
				...
				enum snd_soc_bias_level level)
{
	struct aic3x_priv *aic3x = codec->private_data;
	u8 reg;
//	printk(KERN_WARNING"I'm in aic3x_set_bias_level!!!\n");
	switch (level) {
	...
	aic3x_write(codec,25,0xc0);
//	aic3x_write(codec,15,0x50);
//	aic3x_write(codec,16,0x50);
//	aic3x_write(codec,19,0x04);
//	aic3x_write(codec,22,0x04);

//	aic3x_write(codec,21,0x00);
//	aic3x_write(codec,24,0x00);
//	aic3x_write(codec,26,0x00);
//	aic3x_write(codec,29,0x00);
//	printk(KERN_WARNING"aic3x_set_bias_level is over\n");
	return 0;
}
...
//	aic3x_write(codec, LADC_VOL, DEFAULT_GAIN);
	aic3x_write(codec, LADC_VOL, 0x50);
//	aic3x_write(codec, RADC_VOL, DEFAULT_GAIN);
	aic3x_write(codec, RADC_VOL, 0x50);
